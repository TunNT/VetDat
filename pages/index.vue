  ...
  <div class="login_container">
    <b-container fluid class="text-center">
      <b-row class="m-auto" style="width: 370px">
        ...
        <b-col
          class="d-flex col-12 align-items-between justify-content-between mb-2"
        >
          <el-checkbox v-model="checked" style="font-size: 1rem"
            >Lưu tài khoản</el-checkbox
          >
          <p class="p_label">Quên mật khẩu</p>
        </b-col>
        <b-col cols="12">
          <el-button type="primary" class="w-100" @click="onLoginHandler"
            >Đăng nhập</el-button
          >
        </b-col>
