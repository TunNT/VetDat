                    ...
                    <b-col cols="12" md="5" lg="5" class="mt-5 text-center">
                        <ul class="field-list">
                            ...
                            <li class="field-item">
                                ...
                                <span class="field-value">{{ petSite.petType === 0
                                    ? "Không xác định"
                                    : petSite.petType === 1
                                        ? "Chó"
                                        : petSite.petType === 3
                            ...
                            <li class="field-item">
                                ...
                                <span class="field-value">{{ petSite.petSex === 0
                                    ? "Không xác định"
                                    : petSite.petSex === 1
                                        ? "Đực"
                                        : "Cái" }}</span>
                            ...
                            <li class="field-item">
                                ...
                                <span class="field-value">{{ petSite.petTriet === 0
                                    ? "Không xác định"
                                    : petSite.petTriet === 1
                                        ? "Có"
                                        : "Chưa" }}</span>
                            ...
                            <li class="field-item">
                                ...
                                <span class="field-value">{{ petSite.petDob | FormatDay }}</span>
                            </li>
                            <li class="field-item">
