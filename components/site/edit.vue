<template>
    <div>
        <el-dialog :title="`Sửa site ${itemSync.name}`" :visible="dialogVisible" :before-close="handleClose" center
            top="10vh" width="60%">
            <el-form ref="updateForm" :model="itemSync" :rules="rules" label-width="160px" label-position="left"
                ...
                <el-form-item label="Tên đăng nhập:" prop="login">
                    <el-input class="group-name" placeholder="Vui lòng nhập tên đăng nhập" v-model="itemSync.login">
                    </el-input>
                </el-form-item>
                <el-form-item label="Mật khẩu:" prop="password">
                    <el-input class="group-name" placeholder="Bỏ qua nếu bạn không muốn đổi mật khẩu"
                        v-model="itemSync.password" show-password>
                    </el-input>
                </el-form-item>
                <el-form-item label="Name:" prop="name">
                    <el-input class="group-name" placeholder="Vui lòng nhập tên" v-model="itemSync.name">
                    </el-input>
                </el-form-item>
                <el-form-item label="Liên hệ:" prop="contact">
                    <el-input class="group-name" placeholder="Vui lòng nhập liên hệ" v-model="itemSync.contact">
                    </el-input>
                </el-form-item>
                <el-form-item label="Địa chỉ:" prop="address">
                    <el-input class="group-name" placeholder="Vui lòng nhập địa chỉ" v-model="itemSync.address">
                    </el-input>
                </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button class="btn-add-group" @click="onPreviousSubmit(itemSync)">Xác nhận sửa</el-button>
            </span>
        </el-dialog>
    </div>
</template>
