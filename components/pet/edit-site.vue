<template>
    <div>
        <el-dialog :title="`Edit thú cưng ${itemSync.petName}`" :visible="dialogVisible" :before-close="handleClose" center
            top="10vh" width="60%">
            <el-form ref="updateForm" :model="itemSync" :rules="rules" label-width="160px" label-position="left"
                ...
                <b-row>
                    <b-col cols="6"><el-form-item label="Trạng thái:">
                        ...
                        <el-form-item label="Loại thú cưng:">
                            <template>
                                <el-select v-model="itemSync.petType" placeholder="Loại thú cưng:">
                                    <el-option v-for="item in optionsPetType" :key="item.value" :label="item.label"
                                        :value="item.value">
                                    </el-option>
                                </el-select>
                            </template>
                        ...
                        <el-form-item label="Giới tính vật nuôi:">
                            <template>
                                <el-select v-model="itemSync.petSex" placeholder="Giới tính:">
                                    <el-option v-for="item in optionsPetSex" :key="item.value" :label="item.label"
                                        :value="item.value">
                                    </el-option>
                                </el-select>
                            </template>
                        ...
                        <el-form-item label="Triệt sản:">
                            <template>
                                <el-select v-model="itemSync.petTriet" placeholder="Triệt sản:">
                                    <el-option v-for="item in optionsPetTriet" :key="item.value" :label="item.label"
                                        :value="item.value">
                                    </el-option>
                                </el-select>
                            </template>
                ...
                <el-form-item label="Giống vật nuôi:" prop="petBreed">
                    <el-input class="group-name" placeholder="Vui lòng nhập giống vật nuôi" v-model="itemSync.petBreed">
                    </el-input>
                </el-form-item>

                <el-form-item label="Màu sắc vật nuôi:" prop="petColor">
                    <el-input class="group-name" placeholder="Vui lòng nhập màu sắc vật nuôi" v-model="itemSync.petColor">
                    </el-input>
                </el-form-item>

                <el-form-item label="Tên thú nuôi:" prop="petName">
                    <el-input class="group-name" placeholder="Vui lòng nhập tên thú nuôi" v-model="itemSync.petName">
                    </el-input>
                </el-form-item>
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button class="btn-add-group" @click="onPreviousSubmit">Tạo pet</el-button>
            </span>
        </el-dialog>
    </div>
</template>
